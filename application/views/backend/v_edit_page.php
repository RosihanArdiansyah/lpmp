    ...
    <body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-bubbles"></span><p>Page</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li class="active"><a href="<?php echo site_url('halamanbelakang/page/add_new');?>">Add New</a></li>
                                <li><a href="<?php echo site_url('halamanbelakang/page');?>">Page List</a></li>
                            </ul>
                        </li>
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-calendar"></span><p>Agenda</p><span class="arrow"></span></a>
                            <ul class="sub-menu" style="display: block;">
                                <li><a href="<?=site_url('halamanbelakang/agenda/add_new')?>">Add New</a></li>
                                <li><a href="<?=site_url('halamanbelakang/agenda')?>">Daftar Agenda</a></li>
                            </ul>
                        </li>
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <form action="<?php echo base_url().'halamanbelakang/page/edit'?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-8">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input type="text" name="title" value="<?php echo $b['page_title'];?>" class="form-control" placeholder="Title" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="slug" class="form-control" value="<?php echo $b['page_slug'];?>" placeholder="Permalink" style="background-color: #F8F8F8;outline-color: none;border:0;color:blue;" required>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Contents</label>
                                            <textarea name="contents" id="summernote"><?php echo $b['page_contents'];?></textarea>
                                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                        <div class="form-group">
                                            <label>Image</label>
                                            <input type="file" name="filefoto" class="dropify" data-height="190" data-default-file="<?php echo base_url().'assets/images/'.$b['page_image'];?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" name="page_id" value="<?php echo $b['page_id'];?>" required>
                            ...
                            <div class="panel panel-white">
                                <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" cols="6" rows="6" class="form-control" placeholder="Meta Description"><?php echo $b['page_description'];?></textarea>
                                        </div>
            ...
            $(document).ready(function(){
                ...
                function sendFile(file, editor, welEditable) {
                    ...
                    $.ajax({
                        data: data,
                        type: "POST",
                        url: "<?php echo site_url()?>halamanbelakang/page/upload_image",
                        cache: false,
                        contentType: false,
                        processData: false,
