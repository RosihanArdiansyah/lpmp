        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner">
                    ...
                    <div class="logo-box">
                        <a href="<?php echo site_url('backend/dashboard');?>" class="logo-text"><span>LPMP</span></a>
                    </div><!-- Logo Box -->
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink"><a href="<?php echo site_url('backend/page');?>" class="waves-effect waves-button"><span class="menu-icon icon-settings"></span><p>Pages</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="<?php echo site_url('backend/page/add_new');?>">Add New</a></li>
                                <li><a href="<?php echo site_url('backend/page');?>">Page List</a></li>
                            </ul>
                        </li>
