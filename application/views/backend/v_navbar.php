...
<html>
    ...
    <body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="<?php echo site_url('halamanbelakang/settings');?>" class="waves-effect waves-button"><span class="menu-icon icon-settings"></span><p>Settings</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="<?php echo site_url('halamanbelakang/navbar');?>">Navbar</a></li>
                            </ul>
                        </li>
                        <?php else:?>
                        <?php endif;?>
        ...
        <!-- Modal Add Menu-->
        <form id="add-row-form" action="<?php echo base_url().'halamanbelakang/navbar/insert'?>" method="post" enctype="multipart/form-data">
        ...
        <!-- Modal Add Menu-->
        <form id="add-row-form" action="<?php echo base_url().'halamanbelakang/navbar/insert_submenu'?>" method="post" enctype="multipart/form-data">
        ...
        <!-- Modal Edit Menu-->
        <form id="add-row-form" action="<?php echo base_url().'halamanbelakang/navbar/update'?>" method="post" enctype="multipart/form-data">
        ...
        <!-- Modal Delete Menu-->
        <form id="add-row-form" action="<?php echo base_url().'halamanbelakang/navbar/delete'?>" method="post" enctype="multipart/form-data">
