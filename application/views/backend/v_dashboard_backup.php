                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-bubbles"></span><p>Page</p><span class="arrow"></span></a>
                            <ul class="sub-menu" style="display: block;">
                                <li><a href="<?=site_url('backend/page/add_new')?>">Add New</a></li>
                                <li><a href="<?=site_url('backend/page')?>">Page List</a></li>
                            </ul>
                        </li>
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-picture"></span><p>Galeri</p><span class="arrow"></span></a>
                            <ul class="sub-menu" style="display: block;">
                                <li><a href="<?=site_url('backend/album/add_new')?>">Add Album</a></li>
                                <li><a href="<?=site_url('backend/album')?>">Album</a></li>
                            </ul>
                        </li>
