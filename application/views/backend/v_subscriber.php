...
<html>
    ...
    <body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="<?php echo site_url('halamanbelakang/subscriber');?>" class="waves-effect waves-button"><span class="menu-icon icon-users"></span><p>Subscribers</p></a></li>
                                        ...
                                        <table id="data-table" class="display table" style="width: 100%; cellspacing: 0;">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <?php endif;?>
                                                    <td style="text-align: center;"><a href="<?php echo site_url('halamanbelakang/subscriber/decrease/'.$row->subscribe_id);?>" class="btn btn-sm btn-default" title="Turunkan Rating"><span class="fa fa-minus"></span></a> <?php echo $row->subscribe_rating;?> <a href="<?php echo site_url('halamanbelakang/subscriber/increase/'.$row->subscribe_id);?>" class="btn btn-sm btn-default" title="Naikan Rating"><span class="fa fa-plus"></span></a></td>
        ...
        <!--EDIT RECORD MODAL-->
        <form action="<?php echo site_url('halamanbelakang/subscriber/update');?>" method="post">
        ...
        <!--DELETE RECORD MODAL-->
        <form action="<?php echo site_url('halamanbelakang/subscriber/delete');?>" method="post">
