...
<html>
    ...
    <body class="page-header-fixed compact-menu  pace-done page-sidebar-fixed">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="<?php echo site_url('halamanbelakang/comment');?>" class="waves-effect waves-button"><span class="menu-icon icon-bubbles"></span><p>Comments</p></a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel-body">
                                <div class="search p bg-light m-b-sm">
                                    <form action="<?php echo site_url('halamanbelakang/comment/results');?>" method="GET" data-default="150">
                                ...
                                <div role="tabpanel">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation"><a href="<?php echo site_url('halamanbelakang/comment');?>">All<span class="badge badge-success pull-right m-l-xs"><?php echo $total_all;?></span></a></li>
        ...
        <!-- MODAL REPLY -->
        <form action="<?php echo site_url('halamanbelakang/comment/reply');?>" method="post">
        ...
        <!-- MODAL EDIT -->
        <form action="<?php echo site_url('halamanbelakang/comment/edit');?>" method="post">
        ...
        <!--PUBLISH MODAL-->
        <form action="<?php echo site_url('halamanbelakang/comment/publish');?>" method="post">
        ...
        <!--DELETE RECORD MODAL-->
        <form action="<?php echo site_url('halamanbelakang/comment/delete');?>" method="post">
        ...
        <!--DELETE RECORD MODAL-->
        <form action="<?php echo site_url('halamanbelakang/comment/change');?>" method="post" enctype="multipart/form-data">
            ...
            $(document).ready(function(){
                ...
                function sendFile(file, editor, welEditable) {
                    ...
                    $.ajax({
                        data: data,
                        type: "POST",
                        url: "<?php echo site_url()?>halamanbelakang/comment/upload_image",
                        cache: false,
                        contentType: false,
                        processData: false,
