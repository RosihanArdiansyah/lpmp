...
<html>
    ...
    <body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="<?php echo site_url('halamanbelakang/testimonial');?>" class="waves-effect waves-button"><span class="menu-icon icon-like"></span><p>Testimonials</p></a></li>
        ...
        <!-- Modal -->
        <form id="add-row-form" action="<?php echo base_url().'halamanbelakang/testimonial/insert'?>" method="post" enctype="multipart/form-data">
        ...
        ?>
        <!-- Modal -->
        <form id="add-row-form" action="<?php echo base_url().'halamanbelakang/testimonial/update'?>" method="post" enctype="multipart/form-data">
       ...
       <!-- Modal hapus-->
        <form id="add-row-form" action="<?php echo base_url().'halamanbelakang/testimonial/delete'?>" method="post" enctype="multipart/form-data">
