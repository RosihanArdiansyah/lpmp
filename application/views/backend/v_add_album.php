...
<html>
    <head>
        ...
        <meta name="author" content="LPM Sulawesi Selatan" />
    ...
    <body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
        ...
        <main class="page-content content-wrap">
                ...
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-bubbles"></span><p>Page</p><span class="arrow"></span></a>
                            <ul class="sub-menu"> class="active"><a href="<?php echo site_url('halamanbelakang/page/add_new');?>">Add New</a></li>
            ...
            <div class="page-inner">
                ...
                <div id="main-wrapper">
                    <div class="row">
                        <form action="<?php echo base_url().'halamanbelakang/album/publish'?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-8">
            ...
            $(document).ready(function(){
                ...
                function sendFile(file, editor, welEditable) {
                    ...
                    $.ajax({
                        data: data,
                        type: "POST",
                        url: "<?php echo site_url()?>halamanbelakang/album/upload_image",
                        cache: false,
                        contentType: false,
                        processData: false,
