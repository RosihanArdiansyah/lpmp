...
<html>
    ...
    <body class="page-header-fixed compact-menu pace-done page-sidebar-fixed">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="<?php echo site_url('halamanbelakang/inbox');?>" class="waves-effect waves-button"><span class="menu-icon icon-envelope"></span><p>Inbox</p></a></li>
                        ...
                        <div class="col-md-12">
                            <div class="row mailbox-header">
                                ...
                                <div class="col-md-4 col-md-offset-2">
                                    <form action="<?php echo site_url('halamanbelakang/inbox/result');?>" method="GET">
        ...
        <!--DELETE RECORD MODAL-->
        <form action="<?php echo site_url('halamanbelakang/inbox/delete');?>" method="post">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $('.mailbox-content table tr td').not(":first-child").on('click', function(e) {
                    ...
                    window.location = "<?php echo site_url('halamanbelakang/inbox/read/');?>"+inbox_id;
                });
