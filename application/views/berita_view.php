<div id="main" class="medium-7 large-7 columns">
    ...
    <?php
        ...
        if ($row->post_image == "") {
            $gambar_berita = "default_image.jpg";
        } else {
            $gambar_berita = $row->post_image;
        }
    ?>
    <div class="post post-classic slideUpRun">
        <a title="<?php echo $row->post_title;?>" href="<?php echo site_url('berita/'.$row->post_slug);?>"
            class="image-post item-overlay ">
            <img src="<?php echo base_url().'assets/images/'.$gambar_berita;?>" alt="">
        </a>
        <header class="entry-header">
            <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
            <h3 class="entry-title"><a
                    href="<?php echo site_url('berita/'.$row->post_slug);?>"><?php echo $row->post_title;?></a>
            </h3>
        </header>
